<%-- 
    ...
    Created on : 07-may-2013, 12:13:49
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    //Solo mostraremos Facturas con Estatus 3 (entregada) y 5 (cancelada)
    ...
    //Ademas solo Facturas de Tipo FACTURA EXPRESS CON DESGLOSE
    filtroBusqueda += " AND ID_TIPO_COMPROBANTE=38 ";
    ...
    * Datos de catálogo
    */
    String urlTo = "../cfdi_factura_express_desglose/cfdi_factura_form.jsp";
    ...
    <body>
        <div class="content_wrapper">
            ...
            <div id="content">
                ...
                <div class="inner">
                    <h1>Facturación CFDI - Express con Desglose</h1>
                    ...
                    <div class="onecolumn">
                        <div class="header">
                            <span>
                                <img src="../../images/icon_cfdi_4.png" alt="icon"/>
                                Facturas (CFDI) - Express con Desglose IVA
                            </span>
