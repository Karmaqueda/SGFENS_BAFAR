<%-- 
    Document   : catDepartamentos_list
    Created on : 9/12/2013, 04:39:49 PM
    Author     : Leonardo
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{ idNominaDepartamento = Integer.parseInt(request.getParameter("idNominaDepartamento")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     NominaDepartamento[] nominaDepartamentosDto = new NominaDepartamento[0];
     try{
         limiteRegistros = nominaDepartamentoBO.findNominaDepartamentos(idNominaDepartamento, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        nominaDepartamentosDto = nominaDepartamentoBO.findNominaDepartamentos(idNominaDepartamento, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catNominaDepartamentos/catDepartamentos_form.jsp";
    String paramName = "idNominaDepartamento";
                    ...
                    <div class="onecolumn">
						...
						<tbody>
							<tr>
                                                            <td>
                                                                <div id="search">
                                                                <form action="catDepartamentos_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                            <form id="form_data" name="form_data" action="" method="post">
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            for (NominaDepartamento item:nominaDepartamentosDto){
                                                try{
                                        %>
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            ...
                                            <td>
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdDepartamento()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                &nbsp;&nbsp;
