<%-- 
    Document   : catFoliosCBB_list
    Created on : 24/05/2013, 06:17:24 PM
    Author     : Leonardo
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    if (!buscar.trim().equals(""))
        filtroBusqueda = filtroBusqueda + " AND (SERIE LIKE '%" + buscar + "%' OR SECOFI LIKE '%" +buscar+"%')";
    ...
    * Datos de catálogo
    */
    String urlTo = "../catFolios/catFoliosCBB_form.jsp";
                    ...
                    <div class="onecolumn">
						...
						<tbody>
							<tr>
                                                            <td>
                                                                <div id="search">
                                                                <form action="catFoliosCBB_list.jsp" id="search_form" name="search_form" method="get">
                                                                        <input type="text" id="q" name="q" title="Buscar por Serie / Secofi" class="" style="width: 300px; float: left; "
                                                                               value="<%=buscar%>"/>
                                ...
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            ...
                                            <td><%=item.getSecofi() %></td>                                            
                                            <td><%=(item.getFacturacionMovil()==1)?"Si":"No" %></td>
                                            <td>
