<%-- 
    Document   : login
    Created on : 26/07/2016, 04:19:59 PM
    Author     : leonardo
--%>
...
<head>
    ...
    <link href="../../css/login/login_bafar.css" rel="stylesheet" type="text/css" media="all"/>
...
<div align="center" id="login_wrapper">
		<div id="logo_gespro_02" style="text-align:center; display:none">
                      <img src="../../images/login/bafar_logo.png"  alt="" width="30%" height="30%" /> 
          			  </div>
                      <div class="clear"></div>
		<div id="box-login">
        <div id="welcome"><p>Bienvenidos</p></div>
            ...
            <div id="login_body_window">
                    <div class="inner">
                            ...
                            <form action="login.jsp?<%out.print((request.getQueryString()!=null)&&(!action.trim().equalsIgnoreCase("logout") && !action.trim().equalsIgnoreCase("logoutInactiveSession"))?request.getQueryString():"action=login");%>" method="post" id="form_login" name="form_login">
                                    <p>
                                        <input type="text" placeholder="Usuario" id="username" name="username" style="width:270px" title="Usuario"/>
                                    </p>
                                    <p>
                                        <input type="password" placeholder="Contraseña" id="password" name="password" style="width:270px" title="******"/>
            ...
            <!-- FIN de contenido -->
             <div id="logo_gespro_02" style="text-align:center; display:none">
                      <img src="../../images/login/powered-by.png"  alt="" width="30%" height="30%" /> 
          			  </div>
