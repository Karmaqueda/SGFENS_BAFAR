...
if (user == null || user.getUser() == null) {
    ...
    boolean tipoConsumoCreditosOperacion = false;
    if (empresaMatriz!=null){
        EmpresaPermisoAplicacion permiso = new EmpresaPermisoAplicacionDaoImpl(user.getConn()).findByPrimaryKey(empresaMatriz.getIdEmpresa());
        if (permiso.getTipoConsumoServicio()==1) //Si tiene tipo de consumo por créditos de operacion pre-pago
            tipoConsumoCreditosOperacion = true;
    }
%>
...
<script type="text/javascript">
     ...
     */
      ...
      function consultarMensajesRecibidos(){
         $.get("../mensajes/include_check_messages_ajax.jsp", {param1: "Nada"}, function(respuesta){
...
<div id="header">
        ...
        <div id="account_info" style="float: right;">
            <a href="http://www.movilpyme.com/EVC_guia" target="blank"><img src="../../images/ayuda-20x2.png" title="Ayuda" alt="Ayuda" style="vertical-align: middle;"/></a>
        </div>
        ...
        <div id="account_info" style="float: right;">
            ...
            <jsp:include page="../../jsp/include/notificaciones.jsp"/>
    
        <% if (empresaMatriz!=null && tipoConsumoCreditosOperacion){ %> 
        <div id="account_info" style="float: right;">
            <a href="#">Créditos Operación Disponibles: <%= empresaMatriz.getCreditosOperacion() %></a>
        </div>
        <% } %>
