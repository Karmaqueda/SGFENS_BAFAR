...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    */
    ...
    String urlTo2 = "../cfdi_factura/cfdi_fctra_form.jsp";
                                ...
                                <table width="600px" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="clear">&nbsp;&nbsp;&nbsp;</td>
                                            <td>
                                                <input type="button" id="nuevo" name="nuevo" class="right_switch" value="Nuevo CFDI Impuestos" 
                                                        style="float: right; width: 127px;" onclick="location.href='<%=urlTo2%>?acc=1'"/>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
