<%-- 
    Document   : catGastos_list
    Created on : 18/09/2015, 09:50:57 AM
    Author     : HpPyme
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{ idCatalogoGastos = Integer.parseInt(request.getParameter("idCatalogoGastos")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     CatalogoGastos[] catalogoGastosDto = new CatalogoGastos[0];
     try{
         limiteRegistros = catalogoGastosBO.findGastoMotivo(idCatalogoGastos, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        catalogoGastosDto = catalogoGastosBO.findGastoMotivo(idCatalogoGastos, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catGastos/catGastos_form.jsp";
    String paramName = "idCatalogoGastos";
                                ...
                                <table width="500px" cellpadding="0" cellspacing="0">
                                    <tbody>
                                            <tr>
                                                <td>
                                                    <div id="search">
                                                    <form action="catGastos_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                            <form id="form_data" name="form_data" action="" method="post">
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            for (CatalogoGastos item:catalogoGastosDto){
                                                try{
                                        %>
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            ...
                                            <td>
                                                <%if(item.getIdGastos()>6){  %>
                                                    <%if(RolAutorizacionBO.permisoAccionesElemento(user.getUser().getIdRoles())){%>
                                                        <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdGastos()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                        &nbsp;&nbsp;
                                                    <%}%>                                                
