                    ...
                    <div class="twocolumn">
                        <div class="column_left">
                            ...
                            <div class="content">
                                    ...
                                    <p>
                                        <label>RFC:</label><br/>
                                        <%=clientesDto!=null?clienteBO.getCliente().getRfcCliente():"" %>
                                    </p>
                                    <br/>
                                    <p>
                                        <label>Razón Social:</label><br/>
                                        <%=clientesDto!=null?clienteBO.getCliente().getRazonSocial():"" %>                                  
                                    </p>
                                    <br/>
                                    <p>
                                        ...
                                        if(clientesDto!=null){
                                            ...
                                            clientName += (clientesDto.getNombreCliente()!=null?clientesDto.getNombreCliente():"")+" "+ (clientesDto.getApellidoPaternoCliente()!=null?clientesDto.getApellidoPaternoCliente():" ")+" "+(clientesDto.getApellidoMaternoCliente()!=null?clientesDto.getApellidoMaternoCliente():"");

                                            if(clientName.trim().equals("")){
                                                clientName = clientesDto.getRazonSocial();                            
                                            }

                                            if(clientName.trim().equals("")){
                                                clientName = clientesDto.getNombreComercial();                            
                                            }
                                    ...
                                    <p>
                                        <label>Latitud:</label>
                                        <%=clientesDto!=null?clienteBO.getCliente().getLatitud()!=null?!clienteBO.getCliente().getLatitud().equalsIgnoreCase("null")?!clienteBO.getCliente().getLatitud().equals("0")?!clienteBO.getCliente().getLatitud().equals("")?clienteBO.getCliente().getLatitud():"Sin Ubicación Asignada":"Sin Ubicación Asignada":"Sin Ubicación Asignada":"Sin Ubicación Asignada":"Sin Ubicación Asignada"%>                                   
                                        &nbsp;&nbsp;&nbsp;
                                        <label>Longitud:</label>
                                        <%=clientesDto!=null?clienteBO.getCliente().getLongitud()!=null?!clienteBO.getCliente().getLongitud().equalsIgnoreCase("null")?!clienteBO.getCliente().getLongitud().equals("0")?!clienteBO.getCliente().getLongitud().equals("")?clienteBO.getCliente().getLongitud():"Sin Ubicación Asignada":"Sin Ubicación Asignada":"Sin Ubicación Asignada":"Sin Ubicación Asignada":"Sin Ubicación Asignada"%>                                            
                                    </p>
