<%-- 
    ...
    Created on : 30/11/2015, 03:58:11 PM
    Author     : leonardo
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function grabarVenta(ventass){
                totaless = $("#total").val();
                apprise('¿La venta se cerrará por un monto de:  '+totaless+'?', {'verify':true, 'animate':true, 'textYes':'Si', 'textNo':'No'}, 
                    function(r){
                        if(r){
                        ...
                        success: function(datos){
                            if(datos.indexOf("--EXITO-->", 0)>0){
                               ...
                               apprise('<center><img src=../../images/info.png> <br/>'+ datos +'</center>',{'animate':true},
                                    function(r){
                                        location.href="pedidoConsigna_list.jsp?pagina="+"<%=paginaActual%>";
                                });
                           }else{
                               $("#ajax_loading").fadeOut("slow");
                               $("#ajax_message").html(datos);
            ...
            function calculaTotal(){
                ...
                //calculaSaldoConAdelanto(); //PARA ESTE TIPO DE PEDIDO, SE COMENTO ESTA LINEA
            }
            ...
            <div id="content">
                ...
                <div class="inner">
                    ...
                    <tr style="text-align: right;">
                        <td colspan="7">
                            <h3>Descuento por comisión a Consignatario:
                            Porcentaje:
                            <input type="text" maxlength="5" name="descuento_tasa" id="descuento_tasa"
                                        style="text-align: right;" size="9" value="<%=clienteDto!=null?clienteDto.getComisionConsigna():"0"%>"
                                        onkeypress="return validateNumber(event);"
                                        onchange="calculaDescuento();"/>
                            Monto:
                            <input type="text" name="descuento_importe" id="descuento_importe"
                                                        style="text-align: right;" size="9" value="0"
                                                        onkeypress="return validateNumber(event);"
                                                        readonly />
                            </h3>
                        </td>
                                    ...
                                    <p>
                                        ...
                                        <% if (pedidoDto!=null) {
                                            //Solo se puede modificar el pedido si no ha sido facturado o entregado
                                                if (isPedidoEditable){
                                        %>
                                        <input type="button" id="guardar" value="Cerrar Venta" onclick="grabarVenta('');"/>
                                        &nbsp;&nbsp;&nbsp;
