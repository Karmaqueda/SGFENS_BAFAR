<%-- 
    Document   : editaProductoSesionForm
    Created on : 13/08/2011, 02:21:14 PM
...
<%
    ...
    if (cotizacionSesion!=null){
        if (cotizacionSesion.getListaProducto()!=null){
            if (cotizacionSesion.getListaProducto().size()>0){
                try{
                    productoSesion = cotizacionSesion.getListaProducto().get(index_lista_producto);
                }catch(Exception e){
        ...
        msgError += "<ul>No existe ninguna cotización en sesion";
    }
...
<html>
    <head>
        ...
        <title>Editar Campo de Cotizacion</title>
        ...
        <script language="javascript">
            function modificarProducto(){
                ...
                if (validarAddProducto(indexproducto,productoId,productoCantidad,productoMonto, unidadId)){
                    if(productoId>0){
                        $.ajax({
                            type: "POST",
            ...
            function validarAddProducto(indexProducto,idProducto,cantidad,monto,idUnidad){
                if(indexProducto<0 || idProducto<=0 || cantidad<0 || monto<0 || idUnidad<=0
                    || cantidad=="" || monto==""){
