<%-- 
    Document   : catHistorialMovil_list
    Created on : 2/01/2015, 11:33:22 AM
    Author     : 578
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    if (!buscar.trim().equals(""))
        filtroBusqueda = " AND (NOMBRE_COMERCIAL LIKE '%" + buscar + "%' OR RFC LIKE '%" + buscar + "%')";
    ...
    */
    ...
    try{
     ...
     try{
         limiteRegistros = empresaBO.findEmpresas(-1,-1,0, 0, filtroBusqueda).length;
        ...
        empresasDto = empresaBO.findEmpresas(-1,-1,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catHistorialMovil/catHistorialMovil_DispositivosMoviles_list.jsp";
            ...
            <div id="content">
                ...
                <div class="inner">
                    ...
                    <div class="onecolumn">
                        <div class="header">
                            <span>
                                <img src="../../images/log_16.png" alt="icon"/>
                                ...
                                <table width="500px" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div id="search">
                                                <form action="catHistorialMovil_list.jsp" id="search_form" name="search_form" method="post">
                                                        <input type="text" id="q" name="q" title="Buscar por Nombre Comercial / RFC" class="" style="width: 300px; float: left; "
                                                                value="<%=buscar%>"/>
                                    ...
                                    <tbody>
                                        ...
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>                                           
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdEmpresa()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_consultar.png" alt="Ver Dispositivos" class="help" title="Ver Dispositivos"/></a>
                                                &nbsp;&nbsp;                                                
                                                <%}%>
                                            </td>
                                        </tr>
