<%-- 
    Document   : logistica_consulta
    Created on : 17/01/2013, 10:36:17 PM
    Author     : Luis
--%>
                       ...
                       System.out.println(" **************" + rutaMarcador.getIdCliente());
                        ...
                        if(rutaMarcador.getIdCliente()>0){
                            try{
                                ...
                                title = (clienteDto.getApellidoPaternoCliente()!=null?clienteDto.getApellidoPaternoCliente():"") + " " + (clienteDto.getApellidoMaternoCliente()!=null?clienteDto.getApellidoMaternoCliente():"") + " " + (clienteDto.getNombreCliente()!=null?clienteDto.getNombreCliente():"") ;
                                info = ""
                                    + "<div class='map_dialog'>"
                                    + "    Cliente:<br/>" + (clienteDto.getApellidoPaternoCliente()!=null?clienteDto.getApellidoPaternoCliente():"") + " " + (clienteDto.getApellidoMaternoCliente()!=null?clienteDto.getApellidoMaternoCliente():"") + " " + (clienteDto.getNombreCliente()!=null?clienteDto.getNombreCliente():"") + "<br/><br/>"
                                    + "</div>";
                        ...
                        if(rutaMarcador.getIdProspecto()>0){
                            try{
                                SgfensProspecto prospectoDto = SgfensProspectoDaoFactory.create(user.getConn()).findByPrimaryKey(rutaMarcador.getIdProspecto());
                        ...
                        <div class="column_left">
                            ...
                            <div class="content">
                                    ...
                                    <p>
                                        ...
                                        <%
                                        try{
                                            out.print(promotorDto.getApellidoPaterno() + " " + promotorDto.getApellidoMaterno() + " " + promotorDto.getNombre());
                                        }catch(Exception e){
