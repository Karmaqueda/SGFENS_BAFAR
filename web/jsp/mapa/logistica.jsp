<%-- 
    Document   : logistica
    Created on : 14/01/2013, 02:23:04 PM
    Author     : Luis
--%>
...
//Verifica si el usuario tiene acceso a este topico
    if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
        ...
        int idAutomovil = -1;
        try {
            idAutomovil = Integer.parseInt(request.getParameter("idAutomovil"));
    ...
    */
    ...
    try{
     ...
     try{
         limiteRegistros = marcaBO.findMarcas(-1, (int)idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        rutasDto = marcaBO.findMarcas(-1, (int)idEmpresa,
                                            ...
                                            for (Ruta item : rutasDto) {
                                                try {
                                                    ...
                                                    if(item.getIdEmpleado()>0){
                                                        empleadoDto = EmpleadoDaoFactory.create(user.getConn()).findByPrimaryKey(item.getIdEmpleado());
                                                    }
                                        %>
                                        <tr>
                                            ...
                                            <td><%=(empleadoDto!=null?empleadoDto.getApellidoPaterno() + " " + empleadoDto.getApellidoMaterno() + " " + empleadoDto.getNombre():"")%></td>
