<%-- 
    Document   : catProductosCompra_list
    Created on : 11/08/2015, 05:46:11 PM
    Author     : leonardo
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{ idSgfensProductoServicio = Integer.parseInt(request.getParameter("idSgfensProductoServicio")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     SgfensProductoServicio[] sgfensProductoServiciosDto = new SgfensProductoServicio[0];
     try{
         limiteRegistros = sgfensProductoServicioBO.findSgfensProductoServicios(idSgfensProductoServicio, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        sgfensProductoServiciosDto = sgfensProductoServicioBO.findSgfensProductoServicios(idSgfensProductoServicio, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catProveedores/catProductosCompra_form.jsp";
    String paramName = "idSgfensProductoServicio";
                        ...
                        <div class="content">
                            <form id="form_data" name="form_data" action="" method="post">
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            for (SgfensProductoServicio item:sgfensProductoServiciosDto){
                                                try{
                                        %>
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            <!--<td><input type="checkbox"/></td>-->
                                            <td><%=item.getIdProductoServicio() %></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdProductoServicio()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                &nbsp;&nbsp;
