<%-- 
    Document   : showImage
    Created on : 13-feb-2013, 18:52:14
...
<%
    ...
    try{
         ...
         String ubicacionImagenesCobros = appConfig.getApp_content_path() + rfcEmpresaMatriz +"/abonos/images/";
         
         String archivoImagen= ubicacionImagenesCobros+fileName;
