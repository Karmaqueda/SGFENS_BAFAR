<%-- 
    Document   : cobranzaPromotor_ComparaRutas
    Created on : 7/02/2014, 01:55:51 PM
    Author     : 578
--%>
...
<%-- <%@page import="com.tsp.sct.dao.factory.AutomovilDaoFactory"%>
<%@page import="com.tsp.sct.dao.dto.Automovil"%>--%>
<%@page import="com.tsp.sct.dao.factory.EstadoDaoFactory"%>
<%@page import="com.tsp.sct.dao.dto.Estado"%>
...
<%@page import="com.tsp.sct.dao.dao.EmpleadoBitacoraPosicionDao"%>
<%@page import="com.tsp.sct.bo.EmpleadoBitacoraPosicionBO"%>
<%@page import="com.tsp.sct.bo.RutaBO"%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    System.out.print("dedretert");
    int idEmpresa = user.getUser().getIdEmpresa();
    System.out.print("idEmpresa="+ idEmpresa);
     /*
     * Parámetros
     */
    ...
    EmpleadoBO promotor = new EmpleadoBO(Integer.parseInt(idEmpleado),user.getConn());
    Empleado empleado = promotor.getEmpleado();
    
    RutaBO rutaBO = new RutaBO(user.getConn());
    Ruta rutaDto = null;

    if(idRuta.equals("")){  
        rutaDto = rutaBO.getRutaByIdEmpleado(Integer.parseInt(idEmpleado),user.getConn());
        %>
    ...
    if(fechaIni.equals("")&&fechaFin.equals("")){
       checks = empleadoBitacoraPosicionDaoImpl.findByDynamicWhere(" ID_EMPLEADO = '"+ idEmpleado + "' AND FECHA BETWEEN '" + hoy + " 00:00:01" +"' AND '"+ hoy + " 23:59:59" +"'  GROUP BY latitud,longitud " , null) ; 
       //checks = empleadoBitacoraPosicionDaoImpl.findByDynamicWhere(" ID_EMPLEADO = '"+ idEmpleado + "' AND FECHA BETWEEN '2013/07/04' AND '"+ hoy +"'", null) ; //para pruebas empleado = 24  
       ...
       checks = empleadoBitacoraPosicionDaoImpl.findByDynamicWhere(" ID_EMPLEADO = '"+ idEmpleado + "' AND FECHA >= '"+ txtIni +"' AND FECHA <= '"+ txtFin +"' GROUP BY latitud,longitud ", null) ;
...
*/
            ...
            function rutaMapa(){
                ...
                muestraDetallesPromotor(<%=idEmpleado%>); 
            ...
            function muestraDetallesPromotor(idEmpleado){
                muestraVentanaDetalles("historicoPromotor_ajax.jsp",idEmpleado);
                muestraRutasPromotor("rutasPromotor_ajax.jsp",idEmpleado);
            }
            ...
            function cambiaRuta(idRuta){                   
                    window.location.href = "cobranzaPromotor_ComparaRutas.jsp?idEmpleado="+<%=idEmpleado%>+"&idRuta="+idRuta;                          
            ...
            function reproducirHistorico(){                
                window.location.href = "cobranzaPromotor_ComparaRutas.jsp?idEmpleado="+<%=idEmpleado%>+"&idRuta="+ iRuta +"&fInicio=" + $("#txt_fecha_de").val() + "&fFin="+ $("#txt_fecha_a").val();                  
            }
            ...
            function fillMap(){
                ...
                //for(RutaMarcador rutaMarcador:rutaMarcadores){ 
                        ...
                        */
                        ...
                        //--clientes 
                        clientesDto = new ClienteBO(user.getConn()).findClientes(-1, idEmpresa, 0, 100, " AND ID_CLIENTE IN (SELECT DISTINCT ID_CLIENTE FROM sgfens_cliente_vendedor WHERE ID_USUARIO_VENDEDOR = " + empleado.getIdUsuarios()  + ")");
                        //ClienteDaoFactory.create(user.getConn()).findByDynamicWhere( cQuery , null);
                        
                            for(Cliente clienteDto:clientesDto){
                                
                                String nombreCliente = "";
                                if( clienteDto.getApellidoMaternoCliente() != null || clienteDto.getApellidoPaternoCliente() != null || clienteDto.getNombreCliente() != null){
                                    nombreCliente = clienteDto.getApellidoPaternoCliente() + " "+ clienteDto.getApellidoMaternoCliente() +  " "  + clienteDto.getNombreCliente();
                                }else if(clienteDto.getRazonSocial() != null){
                         ...
                         //--prospectos   
                         prospectosDto = SgfensProspectoDaoFactory.create(user.getConn()).findByDynamicWhere( cQuery , null);   
                        ...
                        //--Puntos de Interes
                        PuntosInteres[] puntosInteresDto = PuntosInteresDaoFactory.create(user.getConn()).findByDynamicWhere(cQuery , null);
                        if(puntosInteresDto.length > 0){
                            for(PuntosInteres puntoInteres:puntosInteresDto){
                                ...
                                try{
                                    tipoPuntoInteresDto = TipoPuntoInteresDaoFactory.create(user.getConn()).findByPrimaryKey(puntoInteres.getIdTipoPunto());
                                }catch(Exception e){}
                            %>
                                puntos.push(
                                    creaMarcador(
                ...
                Empleado[] empleadosDto = empleadoBO.findEmpleados(0, idEmpresa, 0, 0, "");
        ...
        <jsp:include page="../include/leftContent.jsp"/>    
            ...
            <div id="content">
                <span id="nomPromo" style="color: #0074cc; font-weight: bold; padding-left: 350px; position: absolute;">
                    <h1>Vendedor: <%=empleado.getNombre()+" "+empleado.getApellidoPaterno()+" "+empleado.getApellidoMaterno()%>
