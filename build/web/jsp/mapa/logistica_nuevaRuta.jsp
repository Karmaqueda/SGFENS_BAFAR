                                ...
                                <div class="content">
                                    <form id="form_nueva_ruta" name="form_nueva_ruta" action="" method="post">
                                        ...
                                        <p>
                                            ...
                                            <input maxlength="100" type="text" id="txt_nombre_ruta" name="txt_nombre_ruta" style="width:300px;<%=empresaPermisoAplicacionDto.getMostrarGuia() == 1 && verificadorSesionGuiaCerrada.equals("0")?cssDatosObligatorios:""%>"/>
                                        </p>
                                        <br/>
                                        <p>
                                            <label>*Comentarios:</label><br/>
                                            <textarea id="txt_comentario_ruta" name="txt_comentario_ruta" cols="40" rows="3" style="<%=empresaPermisoAplicacionDto.getMostrarGuia() == 1 && verificadorSesionGuiaCerrada.equals("0")?cssDatosObligatorios:""%>"></textarea>
                                        </p>
                                        <br/>
                                        <p>
                                    ...
                                    <form id="form_mapa_buscador" name="form_mapa_buscador" action="" method="post">
                                        <p id="p_promotor_busqueda" style="display: none;">
                                            ...
                                            <select id="cmb_promotor_buscar" name="cmb_promotor_buscar">
                                                ...
                                                <%
                                                Empleado[] empleadosDto = new EmpleadoBO(user.getConn()).findEmpleadosActivos(-1, idEmpresa, 0, 0, "");//EmpleadoDaoFactory.create(user.getConn()).findWhereIdEmpresaEquals(idEmpresa);
