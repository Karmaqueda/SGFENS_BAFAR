                            ...
                            <div class="content">
                                    ...
                                    <p>
                                        ...
                                        <select size="1" id="idEmpleado" name="idEmpleado" >
                                            ...
                                            <%
                                                    //out.print(new EmpleadoBO(user.getConn()).getEmpleadosByIdHTMLCombo(idEmpresa, (movilMensajesDto!=null?movilMensajeBO.getMovilMensaje().getIdEmpleadoReceptor():-1),"" ));
