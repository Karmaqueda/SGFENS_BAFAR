<%-- 
    Document   : catCategoriaProveedor_list
    Created on : 11/08/2015, 04:34:12 PM
    Author     : leonardo
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{ idSgfensProveedorCategoria = Integer.parseInt(request.getParameter("idSgfensProveedorCategoria")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     SgfensProveedorCategoria[] sgfensProveedorCategoriasDto = new SgfensProveedorCategoria[0];
     try{
         limiteRegistros = sgfensProveedorCategoriaBO.findSgfensProveedorCategorias(idSgfensProveedorCategoria, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        sgfensProveedorCategoriasDto = sgfensProveedorCategoriaBO.findSgfensProveedorCategorias(idSgfensProveedorCategoria, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catProveedores/catCategoriaProveedor_form.jsp";
    String paramName = "idSgfensProveedorCategoria";
                    ...
                    <div class="onecolumn">
                        <div class="header">
                            <span>
                                ...
                                Catálogo de Proveedor Categorías
                            </span>
						...
						<tbody>
							<tr>
                                                            <td>
                                                                <div id="search">
                                                                <form action="catCategoriaProveedor_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                            <form id="form_data" name="form_data" action="" method="post">
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            for (SgfensProveedorCategoria item:sgfensProveedorCategoriasDto){
                                                try{
                                        %>
