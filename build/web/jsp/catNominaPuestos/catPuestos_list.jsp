<%-- 
    Document   : catPuestos_list
    Created on : 9/12/2013, 06:53:50 PM
    Author     : Leonardo
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{ idNominaPuesto = Integer.parseInt(request.getParameter("idNominaPuesto")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     NominaPuesto[] nominaPuestosDto = new NominaPuesto[0];
     try{
         limiteRegistros = nominaPuestoBO.findNominaPuestos(idNominaPuesto, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        nominaPuestosDto = nominaPuestoBO.findNominaPuestos(idNominaPuesto, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catNominaPuestos/catPuestos_form.jsp";
    String paramName = "idNominaPuesto";
                    ...
                    <div class="onecolumn">
						...
						<tbody>
							<tr>
                                                            <td>
                                                                <div id="search">
                                                                <form action="catPuestos_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                            <form id="form_data" name="form_data" action="" method="post">
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            for (NominaPuesto item:nominaPuestosDto){
                                                try{
                                        %>
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            <!--<td><input type="checkbox"/></td>-->
                                            <td><%=item.getIdPuesto() %></td>
                                            <td><%=item.getNombre() %></td>
                                            <td><%=item.getDescripcion()%></td>                                            
                                            <td>
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdPuesto()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                &nbsp;&nbsp;
