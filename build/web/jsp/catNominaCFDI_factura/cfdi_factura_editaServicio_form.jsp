<%-- 
    Document   : cfdi_factura_editaServicio_form.jsp
...
<%
    ...
    if (cfdiSesion!=null){
        if (cfdiSesion.getListaServicio()!=null){
            if (cfdiSesion.getListaServicio().size()>0){
                try{
                    servicioSesion = cfdiSesion.getListaServicio().get(index_lista_servicio);
                }catch(Exception e){
