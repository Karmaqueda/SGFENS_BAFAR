...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    if (!buscar.trim().equals(""))
        filtroBusqueda = " AND (NOMBRE_HORARIO LIKE '%" + buscar + "%')";
    ...
    */
    ...
    try{
     ...
     Horario[] horariosDtos = new Horario[0];
     try{
         limiteRegistros = horarioBO.findHorarios(idHorario, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        horariosDtos = horarioBO.findHorarios(idHorario, idEmpresa,
    ...
    */
    ...
    String parametrosPaginacion="idHorario="+idHorario + "&q="+buscar;
