...
<%
    ...
    //variable para un Id dinamico
    int IdCampoFormulario = 0;
    try{
        IdCampoFormulario = Integer.parseInt(request.getParameter("IdCampoFormulario"));
    }catch(Exception ex){}
    
    if(IdCampoFormulario>0){
        //returnURL = ""+IdCampoFormulario;
        queryCustom += "&IdCampoFormulario="+IdCampoFormulario;
    }
