...
//    String idFactura2 = idFactura.replaceAll("\\+", "%2B");
    ...
    String versionCBB = request.getParameter("versionCBB")!=null? new String(request.getParameter("versionCBB").getBytes("ISO-8859-1"),"UTF-8") :"";
    ...
    if (versionCfdDouble==111){
         urlResponse = "/GeneradorPDFs"; //Para CFDI v3.2
     }
...
<html>
    ...
    <body scroll="no" style="background-color: white ; ">
            <center>
                ...
                <a href='<%=request.getContextPath()+urlResponse+"?idComprobanteFiscal="+idComprobanteFiscal+"&accion="+accion%>'>
