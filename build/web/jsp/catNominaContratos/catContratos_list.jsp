<%-- 
    Document   : catContratos_list
    Created on : 10/12/2013, 04:29:14 PM
    Author     : Leonardo
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{ idNominaTipoContrato = Integer.parseInt(request.getParameter("idNominaTipoContrato")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     NominaTipoContrato[] nominaTipoContratosDto = new NominaTipoContrato[0];
     try{
         limiteRegistros = nominaTipoContratoBO.findNominaTipoContratos(idNominaTipoContrato, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        nominaTipoContratosDto = nominaTipoContratoBO.findNominaTipoContratos(idNominaTipoContrato, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catNominaContratos/catContratos_form.jsp";
    String paramName = "idNominaTipoContrato";
                    ...
                    <div class="onecolumn">
						...
						<tbody>
							<tr>
                                                            <td>
                                                                <div id="search">
                                                                <form action="catContratos_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                            <form id="form_data" name="form_data" action="" method="post">
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            for (NominaTipoContrato item:nominaTipoContratosDto){
                                                try{
                                        %>
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            <!--<td><input type="checkbox"/></td>-->
                                            <td><%=item.getIdTipoContrato() %></td>
                                            <td><%=item.getNombre() %></td>
                                            <td><%=item.getDescripcion()%></td>                                            
                                            <td>
                                                <%if(item.getIdEmpresa()!=0){%>
                                                    <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdTipoContrato()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                    &nbsp;&nbsp;
                                                <%}%>
