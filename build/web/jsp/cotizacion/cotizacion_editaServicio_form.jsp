<%-- 
    Document   : cotizacion_editaServicio_form.jsp
    Created on : 10/12/2012, 02:21:14 PM
...
<%
    ...
    if (cotizacionSesion!=null){
        if (cotizacionSesion.getListaServicio()!=null){
            if (cotizacionSesion.getListaServicio().size()>0){
                try{
                    servicioSesion = cotizacionSesion.getListaServicio().get(index_lista_servicio);
                }catch(Exception e){
